...
module cw305_usb_reg_fe #(
    ...
    output reg reg_read_o,  // Read flag. One clock cycle AFTER this flag is high
    // valid data must be present on the reg_data_i bus
    output wire reg_write_o,  // Write flag. When high on rising edge valid data is
    // present on reg_data_o
