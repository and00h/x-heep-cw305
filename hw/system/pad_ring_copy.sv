...
`else
  assign spi_flash_sck_io = spi_flash_sck_o;
  assign spi_flash_sck_i  = spi_flash_sck_o;
`endif
...
`else
  assign spi_flash_sd_2_io = spi_flash_sd_2_o;
  assign spi_flash_sd_2_i  = spi_flash_sd_2_o;
`endif
`ifndef FPGA_CW305
  pad_cell_inout #(
      .PADATTR(0)
...
`else
  assign spi_flash_sd_3_io = spi_flash_sd_3_o;
  assign spi_flash_sd_3_i  = spi_flash_sd_3_o;
`endif
