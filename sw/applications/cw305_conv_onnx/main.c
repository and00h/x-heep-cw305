...
extern void entry(const float tensor_input[1][IN_CHANNELS][SPATIAL_SIZE][SPATIAL_SIZE], float tensor_output[1][OUT_CHANNELS][OUT_SPATIAL_SIZE][OUT_SPATIAL_SIZE]);
...
float __attribute__((section("important_stuff"))) oooo[1][OUT_CHANNELS][OUT_SPATIAL_SIZE][OUT_SPATIAL_SIZE];
...
int main(void)
{
    ...
    volatile tensor_t x_tensor = {
        .data = &x[0][0][0][0],
        .dims = {1, IN_CHANNELS, SPATIAL_SIZE, SPATIAL_SIZE}
    };
