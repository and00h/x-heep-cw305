...
CONV_LAYERS = [
    {"id": 0, "name": "conv1", "in_shape": (1,3,32,32), "out_shape": (1,16,32,32), "strides": (1, 1), "pads": (1, 1, 1, 1), "kernel_shape": (16, 3, 3, 3), "dilations": (1, 1), "group": 1},
    {"id": 1, "name": "conv2", "in_shape": (1,16,16,16), "out_shape": (1,32,16,16), "strides": (1, 1), "pads": (1, 1, 1, 1), "kernel_shape": (32, 16, 3, 3), "dilations": (1, 1), "group": 1},
    {"id": 2, "name": "conv3", "in_shape": (1,32,8,8), "out_shape": (1,64,8,8), "strides": (1, 1), "pads": (1, 1, 1, 1), "kernel_shape": (64, 32, 3, 3), "dilations": (1, 1), "group": 1},
    {"id": 3, "name": "fc1", "M": 1, "N": 32, "K": 1024},
    {"id": 4, "name": "fc2", "M": 1, "N": 10, "K": 32},
]
