...
CONV_LAYERS = [
    {"id": 0, "name": "conv1", "in_shape": (1,1,49,10), "out_shape": (1,64,25,5), "strides": (2, 2), "pads": (4, 1, 5, 1), "kernel_shape": (64, 1, 10, 4), "dilations": (1, 1), "group": 1},
    {"id": 1, "name": "block1_depthwise", "in_shape": (1,64,25,5), "out_shape": (1,64,25,5), "strides": (1, 1), "pads": (1, 1, 1, 1), "kernel_shape": (64, 1, 3, 3), "dilations": (1, 1), "group": 64},
    {"id": 2, "name": "block1_pointwise", "in_shape": (1,64,25,5), "out_shape": (1,64,25,5), "strides": (1, 1), "pads": (0, 0, 0, 0), "kernel_shape": (64, 64, 1, 1), "dilations": (1, 1), "group": 1},
    {"id": 3, "name": "block2_depthwise", "in_shape": (1,64,25,5), "out_shape": (1,64,25,5), "strides": (1, 1), "pads": (1, 1, 1, 1), "kernel_shape": (64, 1, 3, 3), "dilations": (1, 1), "group": 64},
    {"id": 4, "name": "block2_pointwise", "in_shape": (1,64,25,5), "out_shape": (1,64,25,5), "strides": (1, 1), "pads": (0, 0, 0, 0), "kernel_shape": (64, 64, 1, 1), "dilations": (1, 1), "group": 1},
    {"id": 5, "name": "block3_depthwise", "in_shape": (1,64,25,5), "out_shape": (1,64,25,5), "strides": (1, 1), "pads": (1, 1, 1, 1), "kernel_shape": (64, 1, 3, 3), "dilations": (1, 1), "group": 64},
    {"id": 6, "name": "block3_pointwise", "in_shape": (1,64,25,5), "out_shape": (1,64,25,5), "strides": (1, 1), "pads": (0, 0, 0, 0), "kernel_shape": (64, 64, 1, 1), "dilations": (1, 1), "group": 1},
    {"id": 7, "name": "block4_depthwise", "in_shape": (1,64,25,5), "out_shape": (1,64,25,5), "strides": (1, 1), "pads": (1, 1, 1, 1), "kernel_shape": (64, 1, 3, 3), "dilations": (1, 1), "group": 64},
    {"id": 8, "name": "block4_pointwise", "in_shape": (1,64,25,5), "out_shape": (1,64,25,5), "strides": (1, 1), "pads": (0, 0, 0, 0), "kernel_shape": (64, 64, 1, 1), "dilations": (1, 1), "group": 1},
    {"id": 9, "name": "fc_out", "M": 1, "N": 12, "K": 64},
]
...
is_conv_layer = "conv" in CONV_LAYERS[LAYER_IDX]["name"] or "block" in CONV_LAYERS[LAYER_IDX]["name"]
